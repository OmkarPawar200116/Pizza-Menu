      ...
      {numPizza > 0 ? (
        <React.Fragment>
          <p>
            ...
            from our stove oven, all organic, all decisious{" "}
          </p>
          <ul className="pizzas">
            {pizzas.map((pizza) => (
...
function Footer() {
  ...
  // if(hour => openHour && hour <= closeHour) alert("We're currently opened");
...
function Order(props) {
  return (
    <div className="order">
      ...
      {/* <p className="close">Shop will close in {closeHour-hour} hours</p> */}
    </div>
  );
}
